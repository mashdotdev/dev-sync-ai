    ...
    <footer className="py-20 bg-white border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-slate-500 max-w-xs text-sm leading-relaxed">
              The next generation of workflow automation for modern developers and freelance engineering teams.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500">
              ...
              <li><a className="hover:text-indigo-600" href="#">Enterprise</a></li>
        ...
        <div className="pt-8 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-slate-400">© 2023 DevSync AI Inc. All rights reserved.</p>
